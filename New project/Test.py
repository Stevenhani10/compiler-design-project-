        ...
        for Line in range(0 , len(self.Final_List)):
            for Index in range(0, len(self.Final_List[Line])):
                if self.Final_List[Line][Index][1] == "Become":
                    if (self.Final_List[Line][Index - 1][1] == "Variable") and ((self.Final_List[Line][Index + 1][1] in ["Variable", "Integer", "Boolean", "String", "Float"]) or (self.Final_List[Line][Index + 1][0] == "-")):
                        Flag_Save = True
